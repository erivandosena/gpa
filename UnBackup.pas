...
DirectoryListBox1.Directory := ExtractFilePath('C:\Meus documentos\Meus backups\GPA\');
end;
...
begin
SaveDialog.InitialDir := ExtractFilePath('C:\Meus documentos\Meus backups\GPA\');
...
SaveDialog.Options := [ofOverwritePrompt, ofHideReadOnly];
     ...
     begin
          ...
          begin
               MessageBox(FrmBackup.handle,'Foi selecionado o drive "A", disquete de 3½ polegadas.'+#13+'È recomendável que o disquete esteja formatado e rotulado como:'+#13+#13+'"GPA - Cópia de segurança - Disco 1".'+#13+#13+'Pressione OK para continuar.','Aviso',0+48);
